...
DEVICES = [
    ("IST4W1800044", "(주)한국제강", "제2공장 정련로 앞", "부산 사하구 다대로", 35.0966, 128.9663, "159", 9.0),
    ("IST4W1800051", "(주)한국제강", "압연공정 라인 B", "부산 사하구 다대로", 35.0970, 128.9670, "159", 6.0),
    ("IST4W1800077", "대한물류(주)", "옥외 상하차장", "경기 평택시 포승읍", 36.9920, 126.8400, "119", 2.5),
]
