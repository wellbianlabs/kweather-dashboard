      ...
      {data.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height={300}>
          <ComposedChart data={data} margin={{ top: multi ? 24 : 10, right: 14, left: 0, bottom: 0 }}>
            ...
            <Tooltip content={<ChartTooltip units={{ "현장 체감온도": "℃", "야외 체감온도": "℃", "야외 기온": "℃", "체감온도 격차": "℃" }} />} />
            ...
            {hasOutFeels && <Line type="monotone" dataKey="야외 체감온도" stroke="#1790cd" dot={false} strokeWidth={2.2} strokeLinecap="round" activeDot={{ r: 4 }} />}
            <Line type="monotone" dataKey="야외 기온" stroke="#94a3b8" strokeDasharray="5 4" dot={false} strokeWidth={1.4} activeDot={{ r: 3 }} />
          </ComposedChart>
        </ResponsiveContainer>
      )}
    </Paper>
